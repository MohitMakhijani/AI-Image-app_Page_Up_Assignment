...
class BlurBgOnlyView extends StatelessWidget {
  BlurBgOnlyView({super.key});
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    if (controller.pickedFile.value != null) {
                      controller.blurBackground(); // <-- uses blur API
                    } else {
                      Get.snackbar("Error", "Select Image First");
                    }
                  },
                  icon: const Icon(Icons.blur_on, color: Colors.black),
                  label: const Text(
                    "Blur Background",
                    style: TextStyle(color: Colors.black),
                  ),
